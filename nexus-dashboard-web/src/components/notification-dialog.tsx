...
import { ScrollArea } from "@/components/foundation/compat/scroll-area";
...
export function NotificationDialog() {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-start justify-end">
            ...
            {/* Dialog Panel */}
            <div className="relative z-10 flex h-full w-full max-w-md flex-col border-l border-border bg-background shadow-xl animate-in slide-in-from-right duration-200">
                {/* Header */}
        ...
        >
            ...
            {!showAllMode && !notification.is_read && (
                <Button
                    ...
                    disabled={isMarking}
                    className="opacity-0 group-hover:opacity-100 transition-opacity px-2 text-xs text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100"
                >
