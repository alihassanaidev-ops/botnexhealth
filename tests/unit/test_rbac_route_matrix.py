...
ROUTES_BY_BOUNDARY: dict[str, tuple[str, ...]] = {
    ...
    INSTITUTION_ADMIN: (
        ...
        "GET /api/institution/sms-templates/{template_type}",
        "PUT /api/institution/sms-templates/{template_type}",
        "POST /api/institution/sms-templates/{template_type}/reset",
        "GET /api/institution/sms-templates/{template_type}/preview",
        "GET /api/institution/sms-templates/{template_type}/variables",
    ...
    INSTITUTION_OR_LOCATION_ADMIN: (
        ...
        "GET /api/institution/sms-notification-recipients",
    ...
    INSTITUTION_OR_LOCATION_USER: (
        ...
        "GET /api/institution/locations/{loc_slug}/breaks",
        "POST /api/institution/locations/{loc_slug}/breaks",
        "DELETE /api/institution/locations/{loc_slug}/breaks/{break_id}",
