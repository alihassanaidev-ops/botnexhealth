...
ACCEPTED_GAP: dict[str, str] = {
    ...
    "email_sending_identities:provision_email_sending_identity": "GAP: the address patients see",
    "email_sending_identities:update_email_sending_identity": "GAP: the address patients see",
    "email_sending_identities:delete_email_sending_identity": "GAP: the address patients see",
