...
def _make_request(raw_body: bytes, *, signature: str | None = None, timestamp: str | None = None):
    request = MagicMock()
...
def _location(*, institution_id="11111111-1111-1111-1111-111111111111", location_id="loc-1"):
...
async def test_shadow_route_captures_parse_failure_with_200():
    ...
    assert added.raw_payload == raw_body.decode()
    assert added.redacted_payload == {"payload": "[redacted]"}
