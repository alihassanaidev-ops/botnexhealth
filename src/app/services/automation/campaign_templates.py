...
_CALLBACK_AUTOMATION: dict[str, Any] = {
    ...
    "nodes": [
        ...
        },
        {
            ...
            "rules": [{"field": "call_outcome", "op": "in", "value": ["answered", "completed"]}],
            "true_next_node_id": "exit-answered",
            "false_next_node_id": "exit-handoff",
        },
        {"type": "exit", "id": "exit-answered", "outcome": "answered"},
        {"type": "exit", "id": "exit-handoff", "outcome": "handoff"},
    ],
    "compliance": {"content_class": "transactional_care", "consent_required": True},
}
...
TEMPLATES: dict[str, CampaignTemplate] = {
    ...
    "callback-automation": CampaignTemplate(
        ...
        metadata=_metadata(
            ...
            outcome_labels=["answered", "handoff"],
            supported_channels=["voice"],
            required_readiness_checks=["location", "outbound_voice_profile", "voice_consent", "staff_handoff"],
            ...
            analytics={"answered": "answered", "handoff": "handoff"},
            sample_context={
