...
MERGE_FIELD_CATALOG: tuple[MergeFieldSpec, ...] = (
    ...
    MergeFieldSpec(
        name="recall_type_name",
        label="Recall type name",
        description="The recall type name supplied by the practice software.",
        sample="Hygiene",
        group="recall",
        source="context",
        availability="required_context",
    ...
    MergeFieldSpec(
        name="form_name",
        label="Form name",
        description="The connected form the person submitted.",
        sample="New Patient Enquiry",
        group="form",
        source="context",
        availability="required_context",
        requires=("form_name",),
        ...
        resolve=_context_field("form_name"),
    ),
    MergeFieldSpec(
        name="form_provider",
        label="Form provider",
        description="Which provider delivered the submission (meta or typeform).",
        sample="typeform",
        group="form",
        source="context",
        availability="required_context",
        requires=("form_provider",),
        phi_level="none",
        channels=ALL_CHANNELS,
        triggers=("form_submitted",),
        resolve=_context_field("form_provider"),
    ),
    MergeFieldSpec(
        name="sms_reply_body",
